...
$scheduleWeekDays = str_replace('<h2 title="Horário aos dias úteis">Dias Úteis</h2>', '',
    $first->find('div')[2]->innerHtml);
$scheduleSaturdays = str_replace('<h2 title="Horário aos Sábados">Sábados</h2>', '', $first->find('div')[3]->innerHtml);
$scheduleSundays = str_replace('<h2 title="Horário aos Domingos e Feriados">Dom/Feriados</h2>', '',
    $first->find('div')[4]->innerHtml);
