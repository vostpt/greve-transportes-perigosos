        ...
        <div class="container">
            ...
            <form method="POST" action="/submit.php">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Localização" name="local" id="local">
                </div>
                <div class="form-group">
                    <label for="concelho">Concelho</label>
                    <input class="form-control" type="text" placeholder="Concelho" name="concelho" id="concelho">
                </div>
                <div class="form-group">
                    <label for="distrito">Distrito</label>
                    <input class="form-control" type="text" placeholder="Distrito" name="distrito" id="distrito">
                </div>
                <div class="form-group">
                    <label for="fuelType">Tipo de Combustível Não Disponível</label>
                    <select multiple class="form-control" id="fuelType" name="fuelType">
                ...
                <div class="form-group">
                    <label for="fuelTypeGasoleo">Tipo de Gasóleo Não Disponível</label>
                    <select multiple class="form-control" id="fuelTypeGasoleo" name="fuelTypeGasoleo">
                ...
                <div class="form-group">
                    <label for="fuelTypeGasolina">Tipo de Gasolina Não Disponível</label>
                    <select multiple class="form-control" id="fuelTypeGasolina" name="fuelTypeGasolina">
                        <option>95</option>
                        <option>98</option>
                        <option>Aditivada</option>
                        <option>Todas</option>
                    </select>
                </div>
