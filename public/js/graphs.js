...
window.renderChartsGlobalStats = function (dataSourceUri) {
  ...
  drawChartsFuelTypes(data, 'gasoline-chart-area', 'diesel-chart-area', 'lpg-chart-area');
};
...
window.renderChartsBrand = function (data) {
  if (data) {
    ...
    drawChartsFuelTypes(data, 'gasoline-chart-area-brand', 'diesel-chart-area-brand', 'lpg-chart-area-brand');
  }
};
...
window.drawChartsFuelTypes = function (data, gasolineElId, dielseElId, lpgElId) {
  ...
  google.charts.setOnLoadCallback(function () {
    ...
    var chart2 = new google.visualization.BarChart(document.getElementById(gasolineElId));
    ...
    var chart3lpg = new google.visualization.BarChart(document.getElementById(dielseElId));
    ...
    var chart4lpg = new google.visualization.BarChart(document.getElementById(lpgElId));
...
module.exports = __webpack_require__(/*! /home/cvarandas/Projects/vostpt/greve-transportes-perigosos/resources/js/graphs.js */"./resources/js/graphs.js");
